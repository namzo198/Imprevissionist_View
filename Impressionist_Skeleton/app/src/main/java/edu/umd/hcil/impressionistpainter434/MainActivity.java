...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            setContentView(R.layout.activity_onchange);
            _impressionistView = (ImpressionistView) findViewById(R.id.viewImpressionist);
            imageView = (ImageView) findViewById(R.id.viewImage);

            Log.i("Potrait", "You changed to protrait");
            _impressionistView.setImageView(imageView);
        } else if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.activity_main);
            Log.i("Landscape", "You changed to protrait");
        }
    ...
    public void onRestoreInstanceState(Bundle savedState) {
        ...
        mbitmap = savedState.getParcelable("Bitmap");
        imageView = (ImageView) findViewById(R.id.viewImage);
